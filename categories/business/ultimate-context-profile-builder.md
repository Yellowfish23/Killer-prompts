# Ultimate Context Profile Builder Prompt

## Description
A comprehensive prompt that creates a reusable profile capturing your business context, marketing strategy, content approach, and communication preferences. This profile can be pasted into any AI chat for instant, personalized business and marketing advice without repetitive questioning.

## Tags
#business, #marketing, #strategy, #personalization, #profile, #context-building
...
## Examples
When used by a SaaS company offering project management tools:
- The AI created a comprehensive profile capturing the company's unique approach to project management
- The profile detailed their target audience of mid-sized tech companies
- Included specific market differentiators against competitors like Asana and Monday.com
- Outlined their content strategy and marketing channels that resonated with their audience
- Provided clear guidance on communication preferences for future AI interactions
- The company now uses this profile with every AI tool to get instantly personalized marketing advice

## Notes
- This prompt works best with models that can maintain conversation context (Claude, GPT-4, etc.)
- The interview takes approximately 30-45 minutes to complete thoroughly
- The resulting profile can be used with any AI system to provide instantly contextualized responses
- Update the profile quarterly or whenever significant business changes occur
- You can adapt the questions to focus on specific aspects of your business that need more attention

## Source
Original prompt designed for business owners and marketers who regularly use AI tools for business strategy and marketing guidance
